...
echo "0" | trjconv_mpi -f ../max_entr/zygote_m/trj_merg.pdb -s ../diff/zm/Polymer_600_0.4.pdb -o num/equ_$i/init.gro -fr num/equ_$i/frame.ndx
grompp_mpi -f equ.mdp -c num/equ_$i/init.gro -p ../diff/zm/chr14_a_11.top -o num/equ_$i/md.tpr -po num/equ_$i/mdout.mdp
mpirun -np 4 mdrun_mpi -s num/equ_$i/md.tpr -x num/equ_$i/trj.xtc -e num/equ_$i/ener.edr -c num/equ_$i/confout.gro -g num/equ_$i/md.log -cpo num/equ_$i/state.cpt -tableb ../diff/zm/Tables/table.xvg -table ../diff/zm/Tables/table_PM.xvg -tablep ../diff/zm/Tables/table_ME.xvg -plumed pld_zm.dat -noddcheck -pd
...
echo "0" | trjconv_mpi -f num/merg_$i/trj.xtc -s ../diff/zm/Polymer_600_0.4.pdb -o num/merg_rdc_$i/trj.xtc -fr frame_rdc.ndx
