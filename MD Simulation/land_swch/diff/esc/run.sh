...
mkdir num
echo "0" | trjconv_mpi -f ../../max_entr/esc/$i/trajout.xtc -s Polymer_600_0.4.pdb -o num/last_$i.gro -fr frame.ndx
grompp_mpi -f 120.28.mdp -c num/last_$i.gro -p chr14_a_9.top -o num/md_$i.tpr -po num/mdout_$i.mdp
