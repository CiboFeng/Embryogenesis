...
do
	echo "0" | trjconv_mpi -f num/merg_rdc_$j/trj.xtc -s ../clst/zygote_p/Polymer_600_0.4.pdb -o num/reshp_$i/trj.xtc -fr num/reshp_$i/frame.ndx -app
done
echo "0" | trjconv_mpi -f num/reshp_$i/trj.xtc -s ../clst/zygote_p/Polymer_600_0.4.pdb -o num/reshp_$i/trj.pdb
