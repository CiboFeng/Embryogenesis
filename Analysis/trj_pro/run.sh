...
echo "0" | trjconv_mpi -f ../max_entr/zygote_p/trj_merg.pdb -s ../clst/zygote_p/Polymer_600_0.4.pdb -o num/equ_$i/init.gro -fr num/equ_$i/frame.ndx
grompp_mpi -f equ.mdp -c num/equ_$i/init.gro -p ../clst/zygote_p/chr14_a_13.top -o num/equ_$i/md.tpr -po num/equ_$i/mdout.mdp
mpirun -np 4 mdrun_mpi -s num/equ_$i/md.tpr -x num/equ_$i/trj.xtc -e num/equ_$i/ener.edr -c num/equ_$i/confout.gro -g num/equ_$i/md.log -cpo num/equ_$i/state.cpt -tableb ../clst/zygote_p/Tables/table.xvg -table ../clst/zygote_p/Tables/table_PM.xvg -tablep ../clst/zygote_p/Tables/table_ME.xvg -plumed pld_zp.dat -noddcheck -pd
...
echo "0" | trjconv_mpi -f num/merg_$i/trj.xtc -s ../clst/zygote_p/Polymer_600_0.4.pdb -o num/merg_rdc_$i/trj.xtc -fr frame_rdc.ndx
