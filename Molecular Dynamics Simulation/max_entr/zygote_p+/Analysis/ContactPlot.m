...
tickLocations = [0.01,0.03,0.1,0.2,0.5,1.0]; % change to whatever you want
tickLabels    = {'0.01','0.03','0.1','0.2','0.5','1.0'}; % change to whatever you want
...
print ('-dpdf', '-r300', 'ContactMap.pdf')
