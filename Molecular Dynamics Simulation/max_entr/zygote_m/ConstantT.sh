...
#Lambda=2.00
#Lambda=5.00
Lambdas=(0.01 0.01 0.05 0.05 0.10 0.10 0.20 0.20 0.50 0.50 1.00 1.00 1.00 1.00 1.00 1.00 1.00 1.00 1.00 1.00 1.00)
MAXNUM=9
BTIME=1000
...
#for alpha in `seq 13 1 20`
#for alpha in `seq 21 1 30`
#for alpha in `seq 31 1 40`
#for alpha in `seq 41 1 50`
...
EOF
			...
			jobid=$(sbatch --dependency=afterok:$jobid1,$jobid2 --parsable Analysis.sh)
